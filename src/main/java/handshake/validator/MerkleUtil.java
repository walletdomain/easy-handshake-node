 ...
 *   Odd validator at any level: paired with EMPTY_HASH, NOT duplicated
 *   (unlike Bitcoin's power-of-two padding, which duplicates the last validator)
    * <p>
...
public class MerkleUtil {
    ...
    /** Internal validator hash: Blake2b-256(0x01 || left || right). */
